...
<body>
	<div class="container">
						...
						<a href="#">
							<div class="panel ">
								<div class="panel-body">
									...
									<p style="color: #444">
										Governador teve cassação mantida pelo TSE. Presidente da ALE-AM assumirá cargo após execução de acórdão. Facebook · Twitter. Por G1 AM. 05/05/2017 12h44 Atualizado há 8 horas. José Melo (Foto: Adneison Severiano/G1 AM)... 
									</p>
								</div>
							</div>
						</a>
			...
			<div class="col-xs-3">
				<div class="col-xs-12">
					<a href="#" data-toggle="modal" data-target=".bs-example-modal-lg">
						<img src="img/curso.jpg" alt="" class="img-responsive"><br>
					</a>
					<!-- Large modal -->
        ...
        <h4 class="modal-title">Curso de Bombeiro</h4>
      </div>					
      							<div id="cursomid">	
								<img src="img/curso.jpg" alt="" class="img-responsive">
							</div>
							</div>
						</div>
					</div>
